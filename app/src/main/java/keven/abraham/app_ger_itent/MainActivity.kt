package keven.abraham.app_ger_itent
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btContato.setOnClickListener { exibirLocal() }
        btContato.setOnClickListener { exibirSite() }
        btContato.setOnClickListener { exibirNovaTela() }
    ...
    private fun exibirLocal() {
        val dados = Uri.parse("geo: -23.662642276818946, -46.46003896931")
        val intent:Intent = Intent(Intent.ACTION_VIEW,dados)
        startActivity(intent)
    }
